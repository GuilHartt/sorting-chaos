...
1. **O que é um Algoritmo e a notação Big O?**
   Entenda como medimos a eficiência de um código e por que isso importa no mundo real.
2. **Algoritmos de Ordenação Passo a Passo**
   Vamos destrinchar os clássicos: Bubble Sort, Selection Sort, Insertion Sort, Merge Sort e Quick Sort.
3. **Mão na massa**
   Exemplos de código e visualizações passo a passo (literalmente) de como os arrays são modificados em cada etapa.

Vamos começar? Escolha o primeiro capítulo abaixo!
